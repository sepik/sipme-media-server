...
### ====================================================================== ###
##                                                                          ##
##  Sipme Media Server Bootstrap Script                                     ##
##                                                                          ##
### ====================================================================== ###
...
echo ""
      ...
      "$JAVA" $JAVA_OPTS \
         ...
         ua.mobius.media.server.bootstrap.Main "$@"
      MMS_STATUS=$?

#java -Djava.ext.dirs=`pwd`/lib -Dmms.home=. -cp .:mms-standalone-2.0.0.BETA1-SNAPSHOT.jar ua.mobius.media.server.bootstrap.jmx.JMXMain
