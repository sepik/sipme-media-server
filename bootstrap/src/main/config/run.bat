@echo off
rem -------------------------------------------------------------------------
rem Sipme Media Server Bootstrap Script for Win32
rem -------------------------------------------------------------------------
...
:RESTART
"%JAVA%" %JAVA_OPTS% -Djava.ext.dirs="%MMS_ENDORSED_DIRS%" -Dmbrola.base="%MMS_HOME%/mbrola" -classpath "%MMS_CLASSPATH%" ua.mobius.media.server.bootstrap.Main %*
