 ...
 */
package ua.mobius.media.server.bootstrap;
...
public class Main {
    ...
    private void processCommandLine(String[] args) {
        ...
        String programName = System.getProperty("program.name", "Sipme Media Server");
        ...
        while ((c = g.getopt()) != -1) {
            switch (c) {
                ...
                case 'h':
                    ...
                    System.out.println("    -b, --host=<host or ip>       Bind address for all Sipme Media Server services");
                    System.out.println();
                    System.exit(0);
                    break;
