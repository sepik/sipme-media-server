 ...
 * @author Oifa Yulian
 */
public abstract class AbstractOOBSource extends AbstractSource {
     ...
     */
    public AbstractOOBSource(String name, Scheduler scheduler,int queueNumber) {
        super(name);
