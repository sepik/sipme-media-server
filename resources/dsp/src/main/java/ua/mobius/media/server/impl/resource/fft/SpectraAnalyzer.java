...
import ua.mobius.media.Format;
import ua.mobius.media.Buffer;
import ua.mobius.media.format.AudioFormat;
import ua.mobius.media.server.impl.AbstractSink;
...
public class SpectraAnalyzer extends AbstractSink {
     ...
     * (Non Java-doc.)
     * 
     * @see ua.mobius.media.MediaSink.isAcceptable(Format).
     */
