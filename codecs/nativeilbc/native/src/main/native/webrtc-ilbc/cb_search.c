...
void WebRtcIlbcfix_CbSearch(
  ...
  WebRtcSpl_MemSetW32(Crit, 0, 128);
  ...
  WebRtcSpl_MemSetW16(energyW16, 0, CB_EXPAND*128);
  WebRtcSpl_MemSetW16(energyShifts, 0, CB_EXPAND*128);
  ...
  for (stage=0; stage<CB_NSTAGES; stage++) {
    ...
    /*if(stage==1)
    {
        memcpy(out,Crit, (128) * sizeof(int32_t));
        return;
    }*/
    ...
    */
    ...
    if(lTarget==(STATE_LEN-57)) {
	  ...
	  WebRtcSpl_MemSetW16(aug_vec, 0, 256);
