...
public class EncoderState 
{
	...
	public void reset()
	{
		...
		System.arraycopy(CodingFunctions.emptyArray, 0, anaMem, 0, anaMem.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, lsfOld, 0, lsfOld.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, lsfDeqOld, 0, lsfDeqOld.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, lpcBuffer, 0, lpcBuffer.length);		
