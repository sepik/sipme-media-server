...
public class DecoderState 
{
	...
	private int lastLag,consPliCount,prevEnchPl,useEnhancer;
	...
	public void reset()
	{
		...
		System.arraycopy(CodingFunctions.emptyArray, 0, synthMem, 0, synthMem.length);			
		System.arraycopy(Constants.LSF_MEAN, 0, lsfDeqOld, 0, lsfDeqOld.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, prevLpc, 1, prevLpc.length-1);		
		System.arraycopy(CodingFunctions.emptyArray, 0, prevResidual, 0, prevResidual.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, oldSyntDenum, 0, oldSyntDenum.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, enhancementBuffer, 0, enhancementBuffer.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, enhancementPeriod, 0, enhancementPeriod.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, hpiMemX, 0, hpiMemX.length);
		System.arraycopy(CodingFunctions.emptyArray, 0, hpiMemY, 0, hpiMemY.length);
	}
	...
	public void setLastLag(int lastLag)
	{
