...
public class JitterBufferTest {
    ...
    public void testNormalReadWrite() throws Exception {
        ...
        ByteFrame[] media = new ByteFrame[stream.length];
    ...
    public void testInnerSort() throws Exception {
        ...
        ByteFrame buffer = jitterBuffer.read(wallClock.getTime());
...
//        assertEquals(null, buffer);
    ...
    public void testOverflow() {
        ...
        ByteFrame data = jitterBuffer.read(wallClock.getTime());
    ...
    private void checkSequence(ByteFrame[] media) throws Exception {
        boolean res = true;
