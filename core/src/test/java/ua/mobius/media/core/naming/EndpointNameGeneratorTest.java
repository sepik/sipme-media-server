...
public class EndpointNameGeneratorTest {
    ...
    public void testSinglePattern2() {
        String pattern = "mobius/[1..3]/aap";
        nameGenerator.setPattern(pattern);

        assertTrue("Three names remains", nameGenerator.hasMore());
        assertEquals("mobius/1/aap", nameGenerator.next());

        assertTrue("Two names remains", nameGenerator.hasMore());
        assertEquals("mobius/2/aap", nameGenerator.next());

        assertTrue("One name remains", nameGenerator.hasMore());
        assertEquals("mobius/3/aap", nameGenerator.next());
    ...
    public void testSinglePattern3() {
        String pattern = "[1..3]/mobius/aap";
        nameGenerator.setPattern(pattern);

        assertTrue("Three names remains", nameGenerator.hasMore());
        assertEquals("1/mobius/aap", nameGenerator.next());

        assertTrue("Two names remains", nameGenerator.hasMore());
        assertEquals("2/mobius/aap", nameGenerator.next());

        assertTrue("One name remains", nameGenerator.hasMore());
        assertEquals("3/mobius/aap", nameGenerator.next());
