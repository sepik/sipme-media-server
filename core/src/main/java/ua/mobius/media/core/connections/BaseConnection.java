...
import ua.mobius.media.server.*;
import java.util.Collection;
import java.io.IOException;

import ua.mobius.media.CheckPoint;
...
public abstract class BaseConnection implements Connection {
     ...
     * (Non Java-doc).
     *
     * @see ua.mobius.media.server.spi.Connection#getId()
     */
    public int getId() {
        return id;
    }
     ...
     * (Non Java-doc).
     *
     * @see ua.mobius.media.server.spi.Connection#getTextualId()
     */
     ...
     * (Non Java-doc).
     *
     * @see ua.mobius.media.server.spi.Connection#getState()
     */
     ...
     * (Non Java-doc).
     *
     * @see ua.mobius.media.server.spi.Connection#getEndpoint() 
     */
