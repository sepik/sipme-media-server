 ...
 */
package ua.mobius.protocols.mgcp.stack.test;
...
public class TestHarness extends TestCase {
	...
	protected static final String ABORT_ON_FAIL = "ua.mobius.mgcp.stack.test.ABORT_ON_FAIL";

	protected static final String LOG_FILE_NAME = "ua.mobius.mgcp.stack.test.LOG_FILE";
