@echo off
set CLASSPATH=.;tck.jar;deps/jain-mgcp-ri-1.0.jar;deps/mgcp-impl-2.0.0.GA.jar;deps/mscontrol.jar;deps/junit.jar;deps/jain-sip-ri-1.2.146.jar;deps/log4j-1.2.14.jar;
